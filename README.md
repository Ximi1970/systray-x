...
- SysTray-X preferences will be lost when moving from an old Thunderbird version to Thunderbird version 91 or higher due to the storage type change. As of SysTray version 0.8.0 the add-on will use the local storage type instead of the sync type.  
